...
public class Board_Count_ListVO {
	private int idx, type, view_count, u_idx;
	private int reply_count, recommend_score;
	private String title, contents, writer, article_img, profile_img;
